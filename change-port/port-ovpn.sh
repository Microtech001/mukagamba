...
############## WELCOME TO MTS SERVER ###############
############## By MTS ###############
setenv FRIENDLY_NAME "MTS TCP"
client
dev tun
proto tcp
remote $domain 1194
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By MTS
